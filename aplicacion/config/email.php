...
$config['smtp_host']        = 'smtp.gmail.com'; //correo.baer.gob.ve
...
*/
///DESARROLLO
if ($_SERVER["HTTP_ORIGIN"] == "http://pni") {
	$config['smtp_user']        = 'respaldomarreroc@gmail.com';
	$config['smtp_pass']        = '1A2b3C4d.';
} else {
	$config['smtp_user']        = 'pni.oncti@gmail.com';
	$config['smtp_pass']        = 'Aa123456.';
}
