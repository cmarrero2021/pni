<form id="actual_form">
	<div class="row">
		<div class="col-md-3" >
			<div class="form-group">
				<label class="verdeclaro" for="fase_inv">Fase actual de la Investigación</label>
				<select id="fase_inv" name="fase_inv" class="form-control borde-v-3 bgc-granada color-error"></select>
			</div>
		</div>
		<div class="col-md-8">
			<div class="form-group">
				<label class="verdeclaro" for="titulo_investigacion">Título de la investigación</label>
	...
	<div class="row">
		<div class="col-md-11 table-responsive text-nowrap">
			<div class="form-group">
				<label class="verdeclaro" for="responsable_investigacion">Responsables(s) de la investigación
				</label>
				<table id="responsables" class="table w-auto verdeclaro" style="background: transparent !important;">
					<thead class="verdeclaro">
	...
	<div class="row">
		<div class="col-md-2" >
			<div class="form-group">
				<label class="verdeclaro" for="tip_inst">Tipo de Institución</label>
		...
		<div id="salud" style="display:none;">
			<div class="col-md-2">
				<div class="form-group">
					<label class="verdeclaro" for="est_salud">Estado</label>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="verdeclaro" for="mun_salud">Municipio</label>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="verdeclaro" for="par_salud">Parroquia</label>
			...
			<div class="col-md-4">
				<div class="form-group">
					<label class="verdeclaro" for="centro">Institución Salud</label>
		...
		<div id="comunas" style="display:none;">
			<div class="col-md-3">
				<div class="form-group">
					<label class="verdeclaro" for="tip_com">Tipo de Comuna</label>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="verdeclaro" for="comuna">Comuna</label>
		...
		<div id="no_salud" style="display:none;">
			<div class="col-md-3">
				<div class="form-group">
					<label class="verdeclaro" for="cen_salud" id="otros">Centro</label>
	...
	<div class="row">
		<div class="col-md-3" >
			<div class="form-group">
				<label class="verdeclaro" for="lin_invp">Línea de Investigación</label>
		...
		<div class="col-md-5" id="cresul_inv">
			<div class="form-group">
				<label class="verdeclaro" for="resul_inv" id="lbl_resul_inv">Resultados esperados de la investigación
				</label>
	...
	<div class="row">
		<div class="col-md-3" >
			<div class="form-group">
				<label class="verdeclaro" for="tipo_inv">Tipo de Investigación</label>
		...
		<div class="col-md-3" id="tiempoc">
			<div class="form-group">
				<label class="verdeclaro" for="tic">Tiempo de la investigación</label>
				<div id="tic">
					<span class="col-md-6">
						<input type="text" class="form-control borde-v-3 bgc-granada color-error" id ="tiempo_investigacionc" name="tiempo_investigacionc">
					</span>
					<span class="col-md-6">
...
<div class="row" id="fase_diseno" style="display:none;">
	<div class="col-md-3" id="des_fichad">
		<a class="vacio" href="<?php echo base_url(); ?>assets/documentos/ficha_proyecto.doc" download><label  style="cursor:pointer;">Por favor descargue este documento, llénelo adecuadamente y carguelo en el sistema</label></a>
	</div>
	<div class="col-md-3" id="car_fichad">
		<div class="form-group">
			<div class="row">
				<label class="verdeclaro" for="dcargar_ficha">Cargar Ficha de la Investigación</label>
			</div>
			<div class="col-md-9">
	...
	<div class="col-md-4" id="chk_fichad" style="display:none;">
		<div class="form-group">
			<div class="row" style="margin-top:9%;">
				<label class="verdeclaro" for="dcargar_ficha">LA FICHA DE LA INVESTIGACIÓN HA SIDO CARGADA</label>&nbsp;&nbsp;&nbsp;<i class="fa fa-check fa-5 verdeclaro" aria-hidden="true" id="btn-gRes"></i>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		<div class="form-group">
			<label class="verdeclaro" for="ti">Tiempo estimado de la investigación</label>
			<div id="ti">
				<span class="col-md-6">
...
<div class="row" id="fase_ejecucion" style="display:none;">
	<div class="col-md-3" id="cobjetivos_inv" style="display:block;">
		<div class="form-group">
			<label class="verdeclaro" for="objetivos_inv" id="lbl_obj_inv">Objetivos de la investigación
			</label>
		...
		<div class="row">
			<div class="row">
				<div class="col-md-10" id="car_fic_inv_eje">
					<div class="row">
						<div class="form-group">
							<label class="verdeclaro" for="ecargar_ficha" style="margin-left:3%;">Cargue la Ficha de la Investigación</label>
						</div>
						<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-10" id="car_doc_inv_eje">
					<div class="row">
						<div class="form-group">
							<label class="verdeclaro" for="ecargar_proyecto" style="margin-left:3%;">Cargue el proyecto de la Investigación</label>
						</div>
						<div class="col-md-12">
	...
	<div class="col-md-4 col-md-offset-3" id="chk_fichae" style="display:none;margin-top:-14%;">
		<div class="row">
			...
			<div class="form-group">
				<div class="row" style="margin-top:9%;">
					<div class="col-md-12">
						<label class="verdeclaro" for="dcargar_ficha">LA INVESTIGACIÓN HA SIDO CARGADA</label>&nbsp;&nbsp;&nbsp;<i class="fa fa-check fa-5 verdeclaro" aria-hidden="true" id="btn-gRes"></i>
					</div>
				</div>
			</div>
		</div>
...
<div class="row" id="ftici" style="display:none;">
	<div class="col-md-3" id="tiempoe">
		<div class="form-group">
			<label class="verdeclaro" for="tici"  style="margin-left:5%;">Indique el tiempo que duró la investigación</label>
			<div id="tici">
				<span class="col-md-6">
	...
	<div class="col-md-3">
		<div class="form-group">
			<label class="verdeclaro" for="com_etica">Si pasó por el Comité de Ética de alguna institución, indique el tipo</label>
	...
	<div class="col-md-3" id="in_et" style="display:none;">
		<div class="form-group">
			<label class="verdeclaro" for="inst_etica">Institución del Comité de Ética que revisó la investigación</label>
...
<div class="row" id="fase_culminacion" style="display:none;">
	<div class="col-md-6">
		<div class="form-group">
			<label class="verdeclaro" for="resul_invc">Resultado Obtenido
			</label>
	...
	<div class="col-md-6">
		<div class="form-group">
			<label class="verdeclaro" for="impacto">Aplicación
			</label>
	...
	<div class="col-md-4" id="ccfi">
		<div class="form-group">
			<div class="row">
				<label class="verdeclaro" for="ccargar_proyecto">Cargar Ficha de la Investigacion</label>
			</div>
	...
	<div class="col-md-4" id="etq_enla_pub" style="display:none;margin-top: 5%;">;
		<label class="verdeclaro" for="enlace">La investigación ha sido cargada&nbsp;&nbsp;&nbsp;</label><i class="fa fa-check fa-5 csuccess" aria-hidden="true"></i>
	</div>
	<div class="col-md-3">
		<div class="form-group">
			<label class="verdeclaro" for="com_eticac">Si pasó por el Comité de Ética de alguna institución, indique el tipo</label>
	...
	<div class="col-md-3" id="in_etc" style="display:block;">
		<div class="form-group">
			<label class="verdeclaro" for="inst_eticac">Institución del Comité de Ética que revisó la investigación</label>
...
<div class="row" id="sal_etica" style="display:none;">
	<div class="col-md-2">
		<div class="form-group">
			<label class="verdeclaro" for="est_etica">Estado</label>
	...
	<div class="col-md-2">
		<div class="form-group">
			<label class="verdeclaro" for="mun_etica">Municipio</label>
	...
	<div class="col-md-2">
		<div class="form-group">
			<label class="verdeclaro" for="par_etica">Parroquia</label>
	...
	<div class="col-md-4">
		<div class="form-group">
			<label class="verdeclaro" for="centro_etica">Institución Salud</label>
...
<div class="row" id="pub" style="display:none;">
	<div class="col-md-1">
		<div class="form-group text-center">
			<label class="verdeclaro" for="chk_pub">Publicado</label><br/>
	...
	<div class="col-md-5" id="cpub" style="display:none;">
		<div class="form-group" id="enla_pub">
			<label class="verdeclaro" for="enlace">Enlace de la publicación</label>
