...
<body class="cuerpo-r">
	...
	<div class="container margen-login">
		<form id="frm_registro">
			...
			<!--<label class="verdeclaro"style="font-size:150%;">INVESTIGACIÓN ACTUAL (CARGAR SÓLO SI ESTÁ RELACIONADA A <?php echo $grupo_inv; ?>)</label>-->
			<label class="verdeclaro"style="font-size:150%;">INVESTIGACIÓN ACTUAL</label>
			<hr>
